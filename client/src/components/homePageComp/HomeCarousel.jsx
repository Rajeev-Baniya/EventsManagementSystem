...
const HomeCarousel = () => {
  return (
    <div className="home-carousel">
      <Carousel>
        <Carousel.Item>
          <img className="d-block w-100" src={wed1} alt="First slide" />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={wed2} alt="Second slide" />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={wed3} alt="Third slide" />
